...
namespace EohiDataServerApi
{
    public class InfluxDBHelper
    {
        ...
        /// <returns></returns>
        public static string Query(string url,string database, string sql)
        {
            string pathAndQuery = string.Format("query?pretty=true&db={0}&q={1}", database, sql);
            string url2 = url + pathAndQuery;

            string result = HttpHelperGet(url2);
            return result;
        }
