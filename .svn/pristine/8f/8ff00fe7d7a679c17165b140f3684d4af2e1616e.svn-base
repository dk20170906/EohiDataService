<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopjuiDropzone.aspx.cs" Inherits="EohiDataServerApi.TopjuiDropzone" %>
        ...
        jQuery(function ($) {
            ...
            try {
                $(".dropzone").dropzone({
                    ...
                    , init: function () {
                        ...
                        //debugger;
                        window.parent.fileDropzone = myDropzone;
                        //为上传按钮添加点击事件
            ...
            function doCallback(data) {
                try {
                    ...
                    callbackname = url.split("?")[1].split("&")[1].replace("close=", "");
                    callback = eval("window.parent." + callbackname);
                    if (callback) {
                        callback();
                    }
...
<body>
    ...
    <div class="modal-footer" style="height: 40px;">
        ...
        <button class="btn btn-xs btn-primary" type="submit" id="submit-all" disabled="disabled" style="display:none;">开始上传</button>
