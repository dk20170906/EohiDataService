...
namespace EohiDataServerApi
{
    public class ApiHost
    {
        ...
        public string InfluxDBQuery(string url,string database,string sql)
        {
            //var username = "admin";
            //var password = "admin";
            //InfluxDBHelper influxDBHelper = new InfluxDBHelper(url, username, password, "modbusdata");
            var str = InfluxDBHelper.Query(url, database, sql);
