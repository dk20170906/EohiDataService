...
namespace EohiDataServerApi.Areas.ThreeD.Controllers
{
  ...
  "lastPage": true
        ...
        public JsonResult ApiDataInterList(int page, int rows)
        {
            ...
            //if (rows > 0)
            //{
            //    totalPage = (int)Math.Ceiling((double)total / rows);
            //    dic.Add("totalPage", totalPage);
            //}
            //dic.Add("currentPage", page);
            //dic.Add("numPerPage", rows);
            //if (page > 1)
            //{
            //    var previousPage = page - 1;
            //    dic.Add("previousPage", previousPage);
            //    dic.Add("hasPreviousPage", true);
            //}
            //else
            //{
            //    dic.Add("hasPreviousPage", false);
            //}
            //if (page<totalPage)
            //{
            //    var nextPage = page + 1;
            //    dic.Add("nextPage", nextPage);
            //    dic.Add("hasNextPage",true);
            //}
            //else
            //{
            //    dic.Add("hasNextPage", false);
            //}
         
          
            //dic.Add("firstPage", true);
            //dic.Add("lastPage", true);
